...
public class Prjava43Perez18 extends Frame
   ...
   public Prjava43Perez18 () {
      ...
      setTitle("nova finestra prjava43Perez18");  // "this" Frame sets title
   ...
   /** The entry main() method */
    ...
    public static void main(String[] args) {
        new Prjava43Perez18();  // Let the construct do the job
   }
